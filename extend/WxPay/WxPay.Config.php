...
class WxPayConfig extends WxPayConfigInterface
{
	...
	{
		return config('wxconfig.appid');
	}
	public function GetMerchantId()
	{
		return config('wxconfig.shopmchid');
	}
	...
	**/
	...
	{
		return config('wxconfig.notify_url');
	}
	...
	{
		return config('wxconfig.shopkey');
	}
	public function GetAppSecret()
	{
		return config('wxconfig.secret');
	}
